...
export const mockDb = {
  ...
  customers: [
    ...
    // Soft-deleted (is_active = false) — hidden from the customer list and all pickers (FR-CST-010).
    ...
    // Soft-deleted while still holding debt — kept for history, excluded from lists and the dashboard.
    { id: 'cust-5', name: 'Kios Bu Rina',     phone: '08127778888', address: 'Jl. Anggrek No. 3, Jakarta',  isActive: false, isConfidential: false, outstandingDebt: 75000,  createdAt: '2024-11-15T08:00:00.000Z' },
  ] as Customer[],
  ...
  dashboardStats: {
    ...
    recentTransactions: [
      ...
      { id: 'tx-4', createdAt: '2025-04-13T11:00:00.000Z', customerName: undefined,          createdByName: 'Sari Kasir',   type: 'counter',  totalAmount:   5000, paidAmount:   5000, status: 'completed', paymentMethod: 'transfer' },
      { id: 'tx-3', createdAt: '2025-04-12T08:00:00.000Z', customerName: 'Restoran Sedap',  createdByName: 'Rudi Kurir',   type: 'delivery', totalAmount: 125000, paidAmount:      0, status: 'completed', paymentMethod: 'transfer' },
      { id: 'tx-2', createdAt: '2025-04-11T10:00:00.000Z', customerName: 'Warung Pak Joko', createdByName: 'Sari Kasir',   type: 'counter',  totalAmount:  40000, paidAmount:  20000, status: 'completed', paymentMethod: 'transfer' },
      { id: 'tx-1', createdAt: '2025-04-10T09:00:00.000Z', customerName: 'Toko Bu Ani',     createdByName: 'Andi Kurir',   type: 'delivery', totalAmount:  13500, paidAmount:  13500, status: 'completed', paymentMethod: 'cash' },
    ],
    warehouseStock: [
      { productId: 'prod-1', productName: 'Galon Aqua',          productUnit: 'galon',       productCategory: 'refillable', locationId: 'loc-1', locationName: 'Gudang Utama', quantityFilled: 50,   quantityEmpty: 10,   quantityTotal: null },
      { productId: 'prod-2', productName: 'Galon Vit',           productUnit: 'galon',       productCategory: 'refillable', locationId: 'loc-1', locationName: 'Gudang Utama', quantityFilled: 30,   quantityEmpty: 15,   quantityTotal: null },
